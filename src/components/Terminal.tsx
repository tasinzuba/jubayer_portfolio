      ...
      >
        ...
        <div className="flex items-center gap-x-2 min-h-[1.5rem]">
          ...
          <button
            ...
            className="sm:hidden flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-md border border-primary/30 bg-primary/10 text-primary hover:bg-primary/20 active:scale-95 transition-all"
